...
% Last Modified by GUIDE v2.5 08-Aug-2016 15:34:26
...
switch strl(Val);
    ...
    case'Sinc'
        handles.current_data=handles.contour;
end
guidata(hObject.handles)
